                    ...
                    <form action="control/insert.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="school_board" required class="form-control">
                                ...
                                <?php
                                $SqlU = "SELECT * FROM school_boards ";
                                ...
                                while ($rowsU = mysqli_fetch_array($resultU))
                                {
                                    ...
                                    ?>
                                    <option value="<?php echo $id; ?>"><?php echo $board; ?></option>
                                <?php } ?>
                        ...
                        <div class="mb-3 ">
                            <button type="submit" name="save_student" class="btn btn-success">Insert Student</button>
                        </div>
                    </form>
